...
The Gitlab CI compies the SCSS files into a single CSS file after each commit. The latest build is https://gitlab.univ-nantes.fr/bousse-e/stereopticon/-/jobs/artifacts/master/download?job=keep
[available here].
